...
# Store SQLite DB inside backend/
DB_FILE = os.path.join(os.path.dirname(__file__), "gymtracker.db")
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run("backend.app_server:app", host="0.0.0.0", port=8000, reload=True)
